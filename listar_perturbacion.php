...
<audio src="img/sonido.mp3" id="sonido"></audio>
	...
	<header class="header-section sp-pad">
		<h3 class="site-logo">PERTURBACIONES</h3>
	...
	<div class="page-top-area set-bg" data-setbg="img/perturbacion.jpg">
		<div class="breadcrumb-area">
			<a href="principal.php">Inicio</a> / <span>Lista de perturbaciones</span>
		</div>
	</div>
	...
	<section class='container'>
		...
		<!--Modal registro de producto-->
			...
			<div class='modal fade' id='modalRegistro_perturbacion' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>
			<div class='modal-dialog modal-sm' role='document'>
				<div class='modal-content'>
				<div class='modal-header'>
                <h5 class='modal-title' id='myModalLabel'>Notificar perturnacion</h5>
					<h5 class='modal-title' id='myModalLabel'>notifique perturbacion</h5>
					<button type='button' class='close' data-dismiss='modal' aria-label='Close'>
					<span aria-hidden='true'>&times;</span>
					</button>
				</div>
				<form action='admin/registros/registro_perturbacion.php' method='POST'>
					<div class='modal-body'>

						<!--<label>Id sensor</label>
						<input type='text' name='id_sensor' id='email_r' class='form-control inpu-sm'>-->
						<label>Barrio</label>
						<input type='text' name='barrio' id='perturbacion' class='form-control inpu-sm'>
						<!--<label>fecha de creacion</label>
						<input type='text' name='fecha_creacion' id='email_r' class='form-control inpu-sm'>-->
					
					</div>
					<div class='modal-footer'>
					<button type='submit' class='btn btn-primary'>generar alerta</button>
					</div>
				</form>
				</div>
			</div>
		...
		<script type='text/javascript'>
			$(document).ready(function(){
					$('#tabla').load('tablas/tabla_perturbacion.php');
			});
        </script>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<h3>Fecha y hora con mayor reporte de perturbaciones</h3>
<table class='table table-hover table-dark'>
<script src="https://kit.fontawesome.com/711b725bdc.js"></script>

<img src= "img/graf1.png">
<br>
<br>

<h3>Barrios con mayor reporte de perturbaciones</h3>
<table class='table table-hover table-dark'>
<script src="https://kit.fontawesome.com/711b725bdc.js"></script>
